...
! *************************************************************************
 ...
 if (nfiles==1) then
   ...
   case(2)
     ...
     if (is_sus) then
       ...
       if (ans=='Y'.or.ans=='y') then
         ...
         Dtset%gw_icsing=3; Dtset%rcut=zero
         ...
         read(std_in,*)ans
         if (ans=='Y'.or.ans=='y') then
           write(std_out,'(2a)',advance='no') ' Enter gw_icsing: '
           read(std_in,*)Dtset%gw_icsing
         ...
         call vcoul_init(Vcp,Gsphere,Cryst,Qmesh,Kmesh,Dtset%rcut,Dtset%gw_icsing,&
   ...
   case(3)
     ...
     call vcoul_init(Vcp,Gsphere,Cryst,Qmesh,Kmesh,Dtset%rcut,Dtset%gw_icsing,Dtset%vcutgeo,Dtset%ecutsigx,Hscr0%npwe,nqlwl,&
       qlwl,ngfft,comm)
     ABI_FREE(qlwl)
