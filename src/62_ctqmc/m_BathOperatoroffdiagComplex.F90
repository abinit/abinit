...
! subroutines
 public :: BathOperatoroffdiagComplex_init
 public :: BathOperatoroffdiagComplex_reset
 public :: BathOperatoroffdiagComplex_activateParticle
 public :: BathOperatoroffdiagComplex_setMAdd
 public :: BathOperatoroffdiagComplex_setMRemove
 public :: BathOperatoroffdiagComplex_swap
 public :: BathOperatoroffdiagComplex_initF
 public :: BathOperatoroffdiagComplex_setF
 public :: BathOperatoroffdiagComplex_printF
 public :: BathOperatoroffdiagComplex_printM
 public :: BathOperatoroffdiagComplex_destroy
 public :: BathOperatoroffdiagComplex_doCheck
 public :: BathOperatoroffdiagComplex_checkM

! functions
! public :: BathOperatoroffdiagComplex_hybrid
 public :: BathOperatoroffdiagComplex_getDetAdd
 public :: BathOperatoroffdiagComplex_getDetRemove
 public :: BathOperatoroffdiagComplex_getDetF
 public :: BathOperatoroffdiagComplex_getError
!!***

!!****t* m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex
!! NAME
!!  BathOperatoroffdiagComplex
!!
!! FUNCTION
...
TYPE BathOperatoroffdiagComplex
  LOGICAL :: set         = .FALSE.
  ! True if the BathOperatoroffdiagComplex is initialized in BathOperatoroffdiagComplex_init
...
! if opt_nondiag = 1 , flavors= 1
  ...
  ! Modified in  BathOperatoroffdiagComplex_getDetAdd and  BathOperatoroffdiagComplex_getDetRemove
...
!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_init
!! NAME
!!  BathOperatoroffdiagComplex_init
!!
!! FUNCTION
...
SUBROUTINE BathOperatoroffdiagComplex_init(op, flavors, samples, beta, iTech,opt_nondiag)
...
!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_reset
!! NAME
!!  BathOperatoroffdiagComplex_reset
!!
!! FUNCTION
...
SUBROUTINE BathOperatoroffdiagComplex_reset(op)
...
END SUBROUTINE BathOperatoroffdiagComplex_reset
!!***

!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_activateParticle
!! NAME
!!  BathOperatoroffdiagComplex_activateParticle
!!
!! FUNCTION
...
SUBROUTINE BathOperatoroffdiagComplex_activateParticle(op,flavor)
...
!Local variables ------------------------------
  ...
  IF ( op%set .EQV. .TRUE. ) THEN 
    ...
    op%MRemoveFlag  = .FALSE.
  ELSE
    CALL ERROR("BathOperatoroffdiagComplex_activateParticle : not allocated      ")
  END IF
END SUBROUTINE BathOperatoroffdiagComplex_activateParticle
!!***

!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_getDetAdd
!! NAME
!!  BathOperatoroffdiagComplex_getDetAdd
!!
!! FUNCTION
...
!  IF ( Cdag .GE. beta ) &
!    CALL ERROR("BathOperatoroffdiagComplex_getDetAdd : bad case ...              ")
  IF ( op%activeFlavor .LE. 0 ) &
    CALL ERROR("BathOperatoroffdiagComplex_getDetAdd : no active hybrid function ")
...
!  This loop compute all Row and Col except op%updatePosRow
  ...
  DO iflavor = iflavorbegin,iflavorend
    !write(6,*) "       BathOperatoroffdiagComplex_getDetAdd : tails(iflavor)",iflavor,op%tails(iflavor)
...
! "BathOperatoroffdiagComplex_hybrid" interpolates between known values of F for the
!  selected time.
    iflavora=iflavor
...
!    op%R%vec(it) = BathOperatoroffdiagComplex_hybrid(op, Cbeta - list(it)%Cdag)
...
#include "BathOperatoroffdiagComplex_hybrid"
    ...
    !op%Q%vec(it3) = hybrid
!    Q(it) = BathOperatoroffdiagComplex_hybrid(op, Cibeta - Cdagbeta)
  END DO
  END DO
...
!  END IF
  BathOperatoroffdiagComplex_getDetAdd = ratio
      !write(6,*) " getdetAdd",ratio,BathOperatoroffdiagComplex_getDetAdd
  op%MAddFlag   = .TRUE.
!#ifdef CTQMC_CHECK
...
!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_getDetRemove
!! NAME
!!  BathOperatoroffdiagComplex_getDetRemove
!!
!! FUNCTION
...
!Local arguments-------------------------------
  ...
  IF ( op%activeFlavor .LE. 0 ) &
    CALL ERROR("BathOperatoroffdiagComplex_getDetRemove : no active hybrid fun  ")

  op%antiShift = .FALSE.
  tail         = op%sumtails
  ABSposition  = ABS(position)
  IF ( ABSposition .GT. op%tails(op%activeFlavor) ) &
    CALL ERROR("BathOperatoroffdiagComplex_getDetRemove : position > M size     ")
...
END FUNCTION BathOperatoroffdiagComplex_getDetRemove
!!***

!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_getDetF
!! NAME
!!  BathOperatoroffdiagComplex_getDetF
!!
!! FUNCTION
...
#include "BathOperatoroffdiagComplex_hybrid"
  ...
  ENDIF
END FUNCTION BathOperatoroffdiagComplex_getDetF
!!***

!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_setMAdd
!! NAME
!!  BathOperatoroffdiagComplex_setMAdd
!!
!! FUNCTION
...
! ---  op%MAddFlag is put to .TRUE. in BathOperatoroffdiagComplex_getDetAdd.
  IF ( op%MAddFlag .EQV. .FALSE. ) &
    CALL ERROR("BathOperatoroffdiagComplex_setMAdd : MAddFlag turn off           ")

! ---  op%activeFlavor is put in ctqmc_loop
  aF = op%activeFlavor
  IF ( aF .LE. 0 ) &
    CALL ERROR("BathOperatoroffdiagComplex_setMAdd : no active hybrid function   ")
...
!!  enddo
!  old tail
  !write(6,*) "       BathOperatoroffdiagComplex_setMAdd op%sumtails",op%sumtails
  tail = op%sumtails
  new_tail =  tail + 1
...
! ---  data obtained from BathOperatoroffdiagComplex_getDetAdd
...
!#ifdef CTQMC_CHECK
    CALL BathOperatoroffdiagComplex_checkM(op,particle)
!#endif
  END IF

  op%MAddFlag = .FALSE.

END SUBROUTINE BathOperatoroffdiagComplex_setMAdd
!!***

!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_setMRemove
!! NAME
!!  BathOperatoroffdiagComplex_setMRemove
!!
!! FUNCTION
...
!Local variables ------------------------------
  ...
  aF = op%activeFlavor
  IF ( aF .LE. 0 ) &
    CALL ERROR("BathOperatoroffdiagComplex_setMRemove : no active hybrid func    ")
  do it=1,op%sumtails
...
!!      op%M(aF)%mat(1,1) = 1.d0/BathOperatoroffdiagComplex_Hybrid(op, op%beta)
!!      op%MRemoveFlag = .FALSE.
!!      RETURN
!!    END IF
...
END SUBROUTINE BathOperatoroffdiagComplex_setMRemove
!!***

!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_swap
!! NAME
!!  BathOperatoroffdiagComplex_swap
!!
!! FUNCTION
...
SUBROUTINE BathOperatoroffdiagComplex_swap(op, flavor1, flavor2)
...
END SUBROUTINE BathOperatoroffdiagComplex_swap
!!***

!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_initF
!! NAME
!!  BathOperatoroffdiagComplex_initF
!!
!! FUNCTION
...
SUBROUTINE BathOperatoroffdiagComplex_initF(op,ifstream)
...
!Local variables ----------------
  ...
  IF ( op%set .EQV. .FALSE. ) &
    CALL ERROR("BathOperatoroffdiagComplex_initF : BathOperatoroffdiagComplex not set         ")
  ...
  DO iflavor1=1,op%flavors
    ...
    END DO
  END DO
END SUBROUTINE BathOperatoroffdiagComplex_initF
!!***

!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_setF
!! NAME
!!  BathOperatoroffdiagComplex_setF
!!
!! FUNCTION
...
SUBROUTINE BathOperatoroffdiagComplex_setF(op,F)
...
!Arguments ------------------------------------
  ...
  IF ( op%set .EQV. .FALSE. ) &
    CALL ERROR("BathOperatoroffdiagComplex_setF : BathOperatoroffdiagComplex not set          ")

 length  = SIZE(F)
  IF ( length .NE. (op%flavors * op%flavors * op%sizeHybrid) ) &
    CALL ERROR("BathOperatoroffdiagComplex_setF : wrong input F                 ")
  ...
  DO iflavor1=1,op%flavors
    ...
    END DO
  END DO
END SUBROUTINE BathOperatoroffdiagComplex_setF
!!***

!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_printF
!! NAME
!!  BathOperatoroffdiagComplex_printF
!!
!! FUNCTION
!!  print F function
!!
...
SUBROUTINE BathOperatoroffdiagComplex_printF(op,ostream)
...
END SUBROUTINE BathOperatoroffdiagComplex_printF
!!***

!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_printM
!! NAME
!!  BathOperatoroffdiagComplex_printM
!!
!! FUNCTION
!!  print M =F^{-1} matrix
!!
...
SUBROUTINE BathOperatoroffdiagComplex_printM(op,ostream)

!Arguments ------------------------------------
  TYPE(BathOperatoroffdiagComplex), INTENT(IN) :: op
  INTEGER, OPTIONAL , INTENT(IN) :: ostream
!Local variables ------------------------------
  INTEGER                        :: ostream_val
...
!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_printM_matrix
!! NAME
!!  BathOperatoroffdiagComplex_printM_matrix
!!
!! FUNCTION
!!  print M =F^{-1} matrix
!!
...
SUBROUTINE BathOperatoroffdiagComplex_printM_matrix(op,ostream)
...
END SUBROUTINE BathOperatoroffdiagComplex_printM_matrix
!!***

!!****f* ABINIT/m_BathOperatoroffdiagComplex/ BathOperatoroffdiagComplex_destroy
!! NAME
!!   BathOperatoroffdiagComplex_destroy
!!
!! FUNCTION
...
SUBROUTINE  BathOperatoroffdiagComplex_destroy(op)
...
END SUBROUTINE BathOperatoroffdiagComplex_destroy
!!***

!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_doCheck
!! NAME
!!  BathOperatoroffdiagComplex_doCheck
!!
!! FUNCTION
...
SUBROUTINE BathOperatoroffdiagComplex_doCheck(op,opt_check)
...
!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_checkM
!! NAME
...
SUBROUTINE BathOperatoroffdiagComplex_checkM(op,particle)
...
!  CALL MatrixHybComplex_setSize(checkMatrix,tail)
  ...
  IF ( tail .NE. op%M%tail ) THEN
    CALL WARN("BathOperatoroffdiagComplex_checkM : tails are different          ")
    RETURN
  END IF
...
!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_recomputeM
!! NAME
...
SUBROUTINE BathOperatoroffdiagComplex_recomputeM(op,particle,flav_i,flav_j)
...
!    CALL MatrixHybComplex_Print(checkMatrix)
  ...
  ! --- Compare M_update and M to check if calculation of M is correct
END SUBROUTINE BathOperatoroffdiagComplex_recomputeM
!!***

!!****f* ABINIT/m_BathOperatoroffdiagComplex/BathOperatoroffdiagComplex_getError
!! NAME
!!  BathOperatoroffdiagComplex_getError
!!
!! FUNCTION
...
!!
!! OUTPUT
!!  BathOperatoroffdiagComplex_getError=Error in percent
!!
!! SIDE EFFECTS
!!
!! NOTES
...
DOUBLE PRECISION FUNCTION BathOperatoroffdiagComplex_getError(op)

  TYPE(BathOperatoroffdiagComplex), INTENT(IN) :: op

  IF ( op%doCheck .EQV. .TRUE. ) THEN
    BathOperatoroffdiagComplex_getError = op%meanError / DBLE(op%checkNumber)
  ELSE
    BathOperatoroffdiagComplex_getError = 0.d0
  END IF
END FUNCTION BathOperatoroffdiagComplex_getError
!!***
!#endif

END MODULE m_BathOperatoroffdiagComplex
!!***
