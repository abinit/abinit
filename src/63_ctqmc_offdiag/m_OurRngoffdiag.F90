...
MODULE m_OurRngoffdiag
!! Implementation of various RNG with a small footprint

CONTAINS
!!***

!!****f* ABINIT/m_OurRngoffdiag/OurRngoffdiag
!! NAME
!!  OurRngoffdiag
!!
!! FUNCTION
...
SUBROUTINE OurRngoffdiag(xn,rng)
...
!!$  two31m = z'7FFFFFFF'
  ...
  !ii write(6,*) "RANDOM rng",rng
END SUBROUTINE OurRngoffdiag
!!***

END MODULE m_OurRngoffdiag
!!***
