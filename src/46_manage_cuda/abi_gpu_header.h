...
extern "C" {
  ...
  //Headers for Fourwf :
  void alloc_gpu_fourwf_(int *ngfft,
                         int *ndat,
                         int *npwin,
                         int *npwout);
  ...
  void gpu_sphere_in_(const double *cg,
                      double *cfft,
                      const int *kg_k,
                      const int *npw,
                      const int *n1,
  ...
  void gpu_sphere_out_(double *cg,
                       const double *cfft,
                       const int *kg_k,
                       const int *npw,
                       const int *n1,
  ...
  void gpu_density_accumulation_(double *fofr,
                                 double* denpot,
                                 double* weight_r,
                                 double* weight_i,
                                 int* nfft_tot,
  ...
  void gpu_apply_local_potential_(double2 *fofr,
                                  double* denpot,
                                  int* nfft_tot,
                                  int *ndat,
                                  cudaStream_t *compute_stream);
  ...
  //Headers for nonlop:
 void alloc_nonlop_gpu_(int *npwin,
                        int *npwout,
                        int *nspinor,
                        int *natom,
                        int *ntypat,
  ...
  void gpu_compute_nl_hamiltonian_(double2 *proj_gpu,
                                   double2 *dproj_gpu,
                                   double2 *vectin_gpu,
                                   double2 *vectout_gpu,
  ...
  void gpu_compute_nl_projections_(double2 *proj_gpu,
                                   double2 *dproj_gpu,
                                   double2 *vectin_gpu,
                                   double2 *ph3din_gpu,
                                   double *ffnlin_gpu,
  ...
  void gpu_apply_invovl_matrix_alloc(int32_t cplx,
                                     int32_t nprojs,
                                     int32_t ntypat,
                                     int32_t lmnmax,
                                     int32_t realloc);
  ...
  void cuda_gemm_nonlop_gpu_allocate(gemm_nonlop_gpu_t *data,
                                     int32_t npw,
                                     int32_t nprojs);
