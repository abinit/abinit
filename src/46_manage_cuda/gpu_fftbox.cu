...
extern "C" void
gpu_fftbox_c2c_ip(void **plan_pp, int nfft, int batch, int isign, int iscale, int kind, void **d_ff) {
...
extern "C" void
gpu_fftbox_c2c_op(void **plan_pp, int nfft, int batch, int isign, int iscale, int kind,
                  void **d_ff, void **d_gg) {
