...
!Local variables-------------------------------
 ...
 integer :: initialized,ipert,ipert2,ireadwf0,iscf,iscf_eff,ispden,isppol,isym
 ...
 logical :: has_full_piezo,has_allddk,has_strain,is_dfpt=.true.,non_magnetic_xc
...
!  Complete the d2nfr matrix by symmetrization of the existing elements
   ...
   call d2sym3(blkflg,d2nfr,indsym,mpert,natom,dtset%nsym,qphon,symq,symrec,dtset%symrel,timrev,zero_by_symm,omega=dtset%rfomega)
   !write(std_out,*)"blkflg after d2sym3: ", blkflg

   if(rfphon==1.and.psps%n1xccc/=0)then
!    Complete the dyfrx1 matrix by symmetrization of the existing elements
     call d2sym3(blkflgfrx1,dyfrx1,indsym,natom,natom,dtset%nsym,qphon,symq,symrec,dtset%symrel,timrev,zero_by_symm,omega=dtset%rfomega)
   end if
