...
!scalars
 ...
 real(dp) :: dummy_real,dummy_real2, dummy_real3, ecut_eff, el_temp
...
!                    Computation of "on-site" first-order potentials, first-order densities
                     option=1
                     call pawdenpot(dummy_real,el_temp,dummy_real2,dummy_real3,i2pert,dtset%ixc,natom,dtset%natom,&
