...
!S
 ...
 list_vars=trim(list_vars)//' spin_init_state spin_mag_field spin_nctime spin_ntime'
 list_vars=trim(list_vars)//' spin_n1l spin_n2l spin_qpoint spin_temperature spin_temperature_start spin_temperature_end'
 list_vars=trim(list_vars)//'  spin_temperature_nstep spin_tolavg spin_tolvar spin_var_temperature spinat spinmagntarget spmeth'
