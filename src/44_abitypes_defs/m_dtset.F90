...
!B
 ...
 list_vars=trim(list_vars)//' bound_maxCoeff bound_model bound_option  bound_penalty bound_rangePower bound_step bound_temp'
...
!F
 ...
 list_vars=trim(list_vars)//' fit_anhaStrain fit_bancoeff fit_coeff fit_cutoff fit_dispterms fit_drop_rate'
 ...
 list_vars=trim(list_vars)//' fit_nbancoeff fit_ncoeff fit_ncoeff_per_iatom fit_ncoeff_per_cycle'
