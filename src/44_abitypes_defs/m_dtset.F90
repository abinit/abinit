...
!T
 ...
 list_vars=trim(list_vars)//' tmesh tmpdata_prefix'
 list_vars=trim(list_vars)//' tl_nprccg tl_radius tmesh tnons toldfe tolmxde toldff tolimg tolmxf tolrde tolrff tolsym'
