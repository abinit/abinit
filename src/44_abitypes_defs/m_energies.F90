...
!@energies_type
 ...
 if (option==1) then
   ...
   energies_array(19)=energies%e_kin_freeel
   energies_array(20)=energies%edc_kin_freeel
 ...
 if (option==-1) then
   ...
   energies%e_kin_freeel         = energies_array(19)
   energies%edc_kin_freeel       = energies_array(20)
...
!@energies_type
 ...
 ncerr = nctk_defnwrite_dpvars(ncid, [character(len=nctk_slen) :: &
  ...
  "e_entropy", "entropy", "e_ewald", &
  "e_exactX","e_fermie", &
  "e_fock", "e_fockdc", "e_fock0", "e_hartree", "e_kin_freeel", "edc_kin_freeel", &
