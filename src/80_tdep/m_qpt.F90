...
module m_qpt
 ...
 implicit none
  ...
  public :: make_qptpath
  public :: make_specialqpt

contains 

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine make_specialqpt(InVar,Lattice,Qpt,QptBound)
...
#undef ABI_FUNC
#define ABI_FUNC 'make_specialqpt'
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine make_qptpath(InVar,Lattice,Qpt)
...
! Define the special Q points 
  call make_specialqpt(InVar,Lattice,Qpt,QptBound)
