...
!=====================================================================================================
subroutine inbox(tab,natom,tol,&
&                temp) !Optional
...
!=====================================================================================================
 subroutine make_latt(InVar,Lattice)


!This section has been created automatically by the script Abilint (TD).
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'make_latt'
...
! For monoclinic: bravais(1)=2
  if (InVar%bravais(1).eq.2.and.InVar%bravais(2).eq.0) then !monoclinic
    brav=1
    line=1
!FB See the m_qpt.F90 routine for the other modifications
