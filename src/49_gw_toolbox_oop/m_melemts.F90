...
!! SOURCE
 ...
 type,public :: melements_t
  ...
  complex(dp), allocatable :: vxcval(:,:,:,:)
  ! (b1:b2, b1:b2, nkibz, nsppol*nspinor**2)
  ! Matrix elements of the XC potential, valence-only contribution.

  complex(dp), allocatable :: vxcval_hybrid(:,:,:,:)
  ! (b1:b2, b1:b2, nkibz, nsppol*nspinor**2)
