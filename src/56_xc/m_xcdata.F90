...
!!
!! FUNCTION
!!  Returns the ixc of the auxiliary XC functional corresponding to the input ixc 
...
!!
!! OUTPUT
!!  auxc_ixc= 0 if no need of an auxiliary functional, otherwise, returns the ixc of the auxiliary functional.
!!
!! SIDE EFFECTS
!!
!! PARENTS
