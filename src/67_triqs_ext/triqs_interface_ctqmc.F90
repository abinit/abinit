...
! =====================================================================
     ...
     SUBROUTINE Ctqmc_triqs_run(rot_inv,leg_measure,move_shift,move_double,measure_density_matrix,time_invariance,use_norm_as_weight, &
                              ...
                              & imag_threshold,det_precision_warning,det_precision_error,det_singular_threshold,lam,pauli_prob, &
      ...
      REAL(KIND=8), VALUE, INTENT(IN) :: beta,imag_threshold,det_precision_warning,det_precision_error,det_singular_threshold,lam,pauli_prob
