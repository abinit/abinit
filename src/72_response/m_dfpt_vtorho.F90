...
& nsppol,nsym1,ntypat,nvresid1,occkq,occ_rbz,omega,optres,&
...
!scalars
 ...
 real(dp),intent(in) :: fermie1,omega,ucvol
...
&     npw_k,npw1_k,dtset%nspinor,nsppol,n4,n5,n6,occ_k,omega,pawrhoij1_unsym,prtvol,psps,resid_k,&
