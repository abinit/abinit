...
!scalars
 ...
 real(dp) :: enl1_mq,eovl1_mq,epaw1_mq,etotal_mq,evdw_mq,exc1_mq,fermie1_mq,deltae_mq,elmag1_mq
...
&     dbl_nnsclo,dim_eig2rf,doccde_rbz,docckde_mq,dtefield,dtfil,dtset,edocc_mq,&
