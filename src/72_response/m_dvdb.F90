...
!arrays
 ...
 real(dp),allocatable :: maxw(:,:), all_rmod(:), asr_work(:,:,:,:)
...
!scalars
 ...
 integer :: i1, i2, i3, n1, n2, n3, unt, ifft, this_nqpt, method, interpolated
#ifdef HAVE_NETCDF
 integer :: ncid, ncerr
#endif
 type(vdiff_t) :: vd_max
 character(len=500) :: msg
 character(len=fnlen) :: tmp_fname, dump_path
!arrays
 integer :: ngfft(18)
