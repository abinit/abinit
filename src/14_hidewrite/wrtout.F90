...
!!      integrate_gamma_tr_lova,invars1,invars2,inwffil,ioniondist,ioprof,irrzg
!!      kpgio,kramerskronig,ks_ddiago,lapackprof,ldau_self,leave_new,linemin
!!      littlegroup_pert,littlegroup_q,lobpcgwf,local_ks_green,m_abi_etsf
!!      m_abihist,m_abilasi,m_anaddb_dataset,m_argparse,m_atom,m_bfgs,m_bs_defs
!!      m_bse_io,m_bz_mesh,m_cgtools,m_chi0,m_crystal,m_ddb,m_ddb_hdr,m_ddk
!!      m_double_grid,m_dtset,m_dvdb,m_dynmat,m_dyson_solver,m_ebands
...
!!      m_fit_polynomial_coeff,m_fock,m_fstab,m_geometry,m_gkk,m_gpu_detect
!!      m_green,m_gruneisen,m_gsphere,m_hamiltonian,m_harmonics_terms,m_haydock
!!      m_hdr,m_hexc,m_hidecudarec,m_hu,m_ifc,m_initcuda,m_invovl,m_io_kss
!!      m_io_screening,m_ioarr,m_iowf,m_iterators,m_kxc,m_libpaw_libxc
!!      m_libxc_functionals,m_lotf,m_matlu,m_matrix,m_melemts,m_mep
!!      m_multibinit_dataset,m_nctk,m_numeric_tools,m_oper,m_optic_tools
...
!!      m_pawrad,m_pawrhoij,m_pawtab,m_phgamma,m_phonons,m_phpi,m_pimd
!!      m_plowannier,m_polynomial_coeff,m_ppmodel,m_pptools,m_pred_lotf
!!      m_pretty_rec,m_psps,m_psxml2ab,m_ptgroups,m_qparticles,m_rec,m_rf2
!!      m_screen,m_screening,m_self,m_shirley,m_sigma,m_sigmaph,m_skw,m_slk
!!      m_strain,m_vcoul,m_wfd,m_wfk,m_work_var_lotf,m_xc_vdw,m_xpapi
...
!!      mpi_setup,mrgddb,mrgdv,mrggkk,mrgscr,multibinit,multipoles_out
