...
!!      impurity_solve,inarray,ingeo,ingeobld,initberry,initmpi_grid,initro
!!      initwf,inkpts,inpgkk,inpspheads,instrng,intagm,integrate_gamma
...
!!      m_fft,m_fft_mesh,m_fft_prof,m_fftcore,m_fftw3,m_fit_data
