!!****m* ABINIT/m_vcutoff_sphere
!! NAME
!!  m_vcutoff_sphere
!!
!! FUNCTION
!!  This module contains the implementation of the spherical cutoff
!!  of the Coulomb potential in real space.
...
!************************************************************************
 ...
 do iqpt=1,nqpt
   igs=1
   if (ltest .and. normv(qpt(:,iqpt),gmet,'G')<tol3) then ! For small q and G=0, use the limit q-->0.
