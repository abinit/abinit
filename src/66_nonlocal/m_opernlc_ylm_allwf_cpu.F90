!!****m* ABINIT/m_opernlc_ylm_allwf_cpu
!! NAME
...
module m_opernlc_ylm_allwf_cpu
  ...
  public :: opernlc_ylm_allwf_cpu
  !!***

contains
  !!***

  !!****f* ABINIT/opernlc_ylm_allwf_cpu
  !! NAME
  ...
  subroutine opernlc_ylm_allwf_cpu(atindx1,cplex,cplex_enl,cplex_fac, &
    ...
    do iphase=1,dimekbq
      ...
      if (paw_opt==1.or.paw_opt==2.or.paw_opt==4) then
        ...
        if (nspinortot==2 .and. nspinor==nspinortot) then
          ...
          !
          ! this case is removed for GPU parallelization, npspinor>1 is forbidden when use_gpu_flavor is ON
          !
  ...
  end subroutine opernlc_ylm_allwf_cpu
  !!***

end module m_opernlc_ylm_allwf_cpu
!!***
