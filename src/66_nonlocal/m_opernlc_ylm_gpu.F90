...
module m_opernlc_ylm_gpu
  ...
  public :: opernlc_ylm_gpu
  !!***

contains
  !!***

  !!****f* ABINIT/opernlc_ylm_gpu
  !! NAME
  !! opernlc_ylm_gpu
  !!
  !! FUNCTION
  ...
  subroutine opernlc_ylm_gpu(atindx1,cplex,cplex_enl,cplex_fac, &
    &          dimenl1,dimenl2,dimekbq,enl, &
    &          gx,gxfac,gxfac_sij, &
    &          iatm,indlmn,itypat,lambda,mpi_enreg,natom, &
    ...
    do iphase=1,dimekbq
      ...
      if (iphase==1) then
        ...
        ABI_MALLOC(gxfac_,(cplex_fac,nlmn,nincat,nspinor))
      end if
          ...
          if (nspinortot==1) then ! -------------> NO SPINORS
            ...
            do ia=1,nincat
              ...
              do jlmn=1,nlmn
                ...
                if (paw_opt==2) then
                  enl_(1) = enl_(1)-lambda*sij(jjlmn)
                end if
                ...
                if (cplex==2) then
                  gxfac_(2,jlmn,ia,1) = gxfac_(2,jlmn,ia,1)+enl_(1)*gxj(2)
                end if
            ...
            do ispinor=1,nspinor
              ...
              do ia=1,nincat
                ...
                do jlmn=1,nlmn
                  ...
                  if (cplex==2) then
                    gxfac_(2,jlmn,ia,ispinor) = gxfac_(2,jlmn,ia,ispinor)+enl_(1)*gxj(2)
                  end if
                  ...
                  do ilmn=1,nlmn
                    ...
                    if (ilmn < jlmn) then
                      ...
                      if (paw_opt==2) then
                        enl_(1) = enl_(1)-lambda*sij(ijlmn)
                      end if
  ...
  end subroutine opernlc_ylm_gpu
  !!***

end module m_opernlc_ylm_gpu
!!***
