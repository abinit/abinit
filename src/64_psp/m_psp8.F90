...
!!
!! COPYRIGHT
!!  Copyright (C) 1999-2025 ABINIT group (DRH, XG, AF)
...
!arrays
 ...
 real(dp),allocatable :: rad(:),vloc(:),vpspll(:,:),vpspll_irad(:),work_spl(:)

! ***************************************************************************

!File format of formatted drh psp input, as adapted for use
!by the ABINIT code (the 3 first lines have already been read in calling -pspatm- routine):
...
!end if
!
!vbkb are Bloechl-Kleinman-Bylander projectors,(vpsp(r,ll)-vloc(r))*u(r,ll), unnormalized.
!Note that an arbitrary local potential is allowed.
!Set lloc>lmax, and provide projectors for all ll<=lmax
!
!Finally, if fchrg>0:
!
