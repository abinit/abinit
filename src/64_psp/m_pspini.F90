...
!!
!! COPYRIGHT
!!  Copyright (C) 1998-2023 ABINIT group (DCA, XG, GMR, MT, FrD, AF, DRH, YP)
...
!    Return header information
     ...
     if (useupf == 1) then
       ...
       pspcod = 12
       call upf2_to_abinit(ipsp, psps%filpsp(ipsp), dtset%vloc_rcut, znucl, zion, pspxc, lmax, lloc, mmax, &
