...
!************************************************************************
 ...
 do ikcalc=1,sigma%nkcalc
   ...
   call sigma%setup_kcalc(dtset, cryst, ebands, ikcalc, dtset%prtvol, comm)
...
! *************************************************************************
 ...
 ! end if
 ! call xmpi_barrier(self%comm_ncwrite%value)
 ! NCF_CHECK(nctk_open_modify(self%ncid, path, self%comm_ncwrite%value))
 !end if
#endif
