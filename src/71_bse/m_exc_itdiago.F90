...
! real(dp) :: deold
 ...
 !complex(dp) :: cg_gamma,dotgg,old_dotgg
...
! real(dp),allocatable :: gsc(:,:),cg(:,:)
 ...
 complex(dp),allocatable :: cg_dir(:),grad_dir(:),prc_dir(:)
 complex(dp),allocatable :: old_cg_dir(:)
!************************************************************************
...
&  " tolwfr:    ",tolwfr_
 ...
 bsize_hmat = 2*dp*hexc_size*my_nt
 ...
 bsize_phi_block = 2*sp*my_nt*nstates
...
! real(dp),allocatable :: evec(:,:)
 complex(dp),allocatable :: sub_ham(:,:),sub_pham(:),hphi_tot(:)
...
!arrays
 complex(dp),allocatable :: overlap(:,:),povlp(:)
!************************************************************************
