...
!integer :: dtset_iprcel
 ...
 real(dp) :: ecutf,ecutsus,edum,elast,etotal,evxc,fermie,gsqcut,hyb_mixing,hybrid_mixing_sr
...
&         psps%usepaw,xred,xred_old,ylm,psps%ziontypat,psps%znuclpsp)
   ...
   hyb_mixing=zero;hybrid_mixing_sr=zero
   if (usefock==1) then
     if (istep==1) then
...
&         fock%fock_common%symrec,dtset%typat,usecprj,dtset%use_gpu_cuda,dtset%wtk,xred,ylm)
     ...
     !Used locally
     hyb_mixing=fock%fock_common%hybrid_mixing ; hybrid_mixing_sr=fock%fock_common%hybrid_mixing_sr
...
&     comm_atom=mpi_enreg%comm_atom,mpi_atmtab=mpi_enreg%my_atmtab,&
&     hyb_mixing=hyb_mixing,hyb_mixing_sr=hybrid_mixing_sr,&
...
&       hyb_mixing=hyb_mixing,hyb_mixing_sr=hybrid_mixing_sr,comm_atom=mpi_enreg%comm_atom,mpi_atmtab=mpi_enreg%my_atmtab,&
