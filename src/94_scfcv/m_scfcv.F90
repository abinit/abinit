...
&  dmatpawu,dtefield,dtfil,dtorbmag,dtpawuj,dtset,ecore,eigen,hdr,hightemp,&
...
&    this%dtset,this%ecore,this%eigen,electronpositron,this%fatvshift,this%hdr,this%hightemp,this%indsym,&
