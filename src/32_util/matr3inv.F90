...
!!      invars2,inwffil,m_cut3d,m_ddb,m_ddk,m_double_grid,m_dvdb,m_dynmat
!!      m_ebands,m_esymm,m_ewald,m_fock,m_fstab,m_ifc,m_phgamma
!!      m_phonon_supercell,m_phonons,m_psps,make_efg_el,make_efg_ion,metric
!!      optic,outwant,pimd_langevin_npt,prtxf,relaxpol,smpbz,stresssym,symbrav
!!      symlatt,symmetrize_rprimd,symrelrot,symrhg,tddft,testkgrid,tetrahedron
!!      thmeig,uderiv,xcart2xred,xfpack_x2vin
!!
!! CHILDREN
!!
!! SOURCE
