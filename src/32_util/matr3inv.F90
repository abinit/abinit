...
!!      m_pimd,m_psps,m_strain,m_supercell,m_tdep_latt,make_efg_el,make_efg_ion
!!      metric,mover,optic,outwant,pimd_langevin_npt,prtxf,relaxpol,respfn
!!      smpbz,stresssym,symbrav,symlatt,symmetrize_rprimd,symrelrot,symrhg
!!      tddft,testkgrid,thmeig,uderiv,xcart2xred,xfpack_x2vin
!!
!! CHILDREN
!!
!! SOURCE
