...
&     'impose dmft_dc = 5'
   ...
   call intagm(dprarr,intarr,jdtset,marr,1,string(1:lenstr),'dmft_x2m2y',tread,'INT')
   if(tread==1) dtset%dmft_x2m2y=intarr(1)
 ...
 &  ((dtset%dmft_t2g==0).and.(dtset%dmft_x2m2y==0))) then
