...
&       reshape(dtsets(idtset)%gw_qlwl(1:3,1:dtsets(idtset)%gw_nqlwl),(/ narrm(idtset) /) )
 ...
 dprarr(1,:)=dtsets(:)%extfpmd_ecut
 call prttagm(dprarr,intarr,iout,jdtset_,1,marr,1,narrm,ncid,ndtset_alloc,'extfpmd_ecut','ENE',0)
 ...
 intarr(1,:)=dtsets(:)%extfpmd_truecg
 call prttagm(dprarr,intarr,iout,jdtset_,2,marr,1,narrm,ncid,ndtset_alloc,'extfpmd_truecg','INT',0)
