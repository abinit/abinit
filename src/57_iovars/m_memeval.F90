...
!scalars
 ...
 integer :: spgroup,timrev,usepaw,useylm,use_gpu_flavor,xclevel
...
&       dtsets(idtset)%typat,ucvol,usepaw,useylm,use_gpu_flavor,xclevel)
...
&     ntypat,occopt,optddk,optphon,mem_test,optstrs,prtvol,useylm,use_gpu_flavor,xclevel)
   end if
...
& prtvol,pspheads,qphon,tfkinfunc,typat,ucvol,usepaw,useylm,use_gpu_flavor,xclevel)
...
!scalars
 ...
 integer,intent(in) :: prtvol,tfkinfunc,usepaw,useylm,use_gpu_flavor,xclevel
 real(dp) :: ucvol
...
!firstchar=' ';if (use_gpu_flavor/=0) firstchar='_'
...
& occopt,optddk,optphon,option,optstrs,prtvol,useylm,use_gpu_flavor,xclevel)
...
!scalars
 ...
 integer,intent(in) :: use_gpu_flavor,xclevel
 type(MPI_type),intent(in) :: mpi_enreg
!arrays
...
! **************************************************************************
 ...
 firstchar=' ';if (use_gpu_flavor/=ABI_GPU_DISABLED) firstchar='_'
