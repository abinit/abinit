...
!  ffnl_lw
   ...
   ! fock_icutcoul ! FBruneval: I have forbidden values 1 and 2 since they are buggy
   call chkint_eq(0,0,cond_string,cond_values,ierr,'fock_icutcoul',dt%fock_icutcoul,3,[0,4,5],iout)
