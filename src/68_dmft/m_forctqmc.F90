...
! ======================================
 ...
 if(paw_dmft%ientropy==1) ABI_DATATYPE_ALLOCATE(udens_atoms_for_s,(natom))
 ...
 do iatom=1,cryst_struc%natom
   ...
   if(lpawu/=-1) then
     ...
     if(paw_dmft%ientropy==1) ABI_ALLOCATE(udens_atoms_for_s(iatom)%value,(2*(2*lpawu+1),2*(2*lpawu+1)))
