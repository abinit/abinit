...
!!
!! COPYRIGHT
!!  Copyright (C) 2017-2023 ABINIT group (SPr)
...
!Local variables-------------------------------
 ...
 real(dp) :: fcart(3,ab_mover%natom),gred(3,ab_mover%natom)                     ! cartesian forces, and gradient in reduced coordinates
