...
!!
!! FUNCTION
!! Ionmov predictors (9) Langevin dynamics algorithm using PIMD predictor
!!
!! IONMOV 9:
...
subroutine pred_langevin_pimd(ab_mover,hist,icycle,itime,ncycle,ntime,zDEBUG,iexit,skipcycle,pimd_param)
...
!arrays
 ...
 real(dp) :: strten(6)
! Set PIMD variables
 real(dp) :: pimd_etotal(1),pimd_stressin(3,3,1),pimd_xred(3,ab_mover%natom,1),pimd_xred_next(3,ab_mover%natom,1)
 real(dp) :: pimd_xred_prev(3,ab_mover%natom,1),pimd_forces(3,ab_mover%natom,1)
 real(dp) :: pimd_vel(3,ab_mover%natom,1)
