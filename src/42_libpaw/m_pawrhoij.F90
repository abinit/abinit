...
!scalars
 ...
 integer,optional,intent(in):: comm_atom,ngrhoij,nlmnmix,qphase,use_rhoij_,use_rhoijp,use_rhoijres
...
!scalars
 ...
 integer :: nspden_in,nspden_out,paral_case,qphase_in,qphase_out,use_rhoij_,use_rhoijp,use_rhoijres
