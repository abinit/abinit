...
!!      m_hamiltonian,m_io_kss,m_ioarr,m_mep,m_monte_carlo,m_pawpwij
...
!!      newrho,newvtr,nres2vres,odamix,optic,pawgrnl,prcref,prcref_PMA
!!      pred_bfgs,pred_delocint,pred_diisrelax,pred_isokinetic,pred_isothermal
!!      pred_langevin,pred_lbfgs,pred_nose,pred_srkna14,pred_steepdesc
...
!!      wrt_moldyn_netcdf,wvl_initro,xfpack_vin2x,xfpack_x2vin
!!
!! CHILDREN
!!      matr3inv,wrtout
!!
