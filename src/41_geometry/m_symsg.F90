...
!!
!! COPYRIGHT
!!  Copyright (C) 1999-2022 ABINIT group (RC,XG)
...
!  case(365,377,413,425,461,473,509,521)
   case(377,413,425,461,473,509,521)  !XG230719
     symafm(2)=-1
     symafm(5:6)=-1
...
!  case(369,381,417,429,465,477,513,525)
   case(381,417,429,465,477,513,525) !XG230719
     symafm(2)=-1
     symafm(5)=-1
   ...
   case(371,383,419,431,467,479,515,527,559,569)
     symafm(6)=-1
!  case(553,563)
   case(365,553,563) !XG230719
     symafm(5:6)=-1
!  case(557,567)
   case(369,557,567) !XG230719
     symafm(5)=-1
   end select
 end if
