!!****f* ABINIT/m_slicewf_cprj
!! NAME
!! m_slicewf_cprj
!!
!! FUNCTION
!! This module contains a routine updating the whole wave functions at a given k-point,
!! using the Spectrum Slicing filtering method (2021 implementation using xG abstraction layer)
...
!!****f* m_slicewf/slicewf_cprj
!! NAME
!! slicewf_cprj
!!
!! FUNCTION
!! This routine updates the whole wave functions set at a given k-point,
!! using the Spectrum Slicing method (2021 version using xG abstraction layer)
!!
!! INPUTS
...
subroutine slicewf_cprj(cg,dtset,eig,occ,enl_out,gs_hamk,mpi_enreg,&
