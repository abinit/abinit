...
module  m_slc_dynamics
  ...
  subroutine run_time(self, calculator, displacement, strain, spin, lwf)
  ...
  subroutine run_one_step(self, effpot, displacement, strain, spin, lwf)
    ...
    call self%spin_mover%run_one_step(effpot=effpot, displacement=displacement, strain=strain, lwf=lwf)
    call self%lattice_mover%run_one_step(effpot=effpot, spin=spin, lwf=lwf)
