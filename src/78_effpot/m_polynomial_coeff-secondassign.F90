...
!local
!variable
  integer :: ncoeff1,ncoeff2,ncoeff_out,i
!array
! *************************************************************************

!Free output 
 !if(allocated(coeff_list_out))then
 !  write(std_out,*) "I free the list, willy"
   call polynomial_coeff_list_free(coeff_list_out)
 !endif
...
!!****f* m_polynomial_coeff/coeff_copy
!! NAME
!! coeff_copy
!!
!! FUNCTION
...
subroutine coeff_copy(coeff_out,coeff_in)
!Arguments ------------------------------------
 implicit none

!Arguments ------------------------------------
  type(polynomial_coeff_type), intent(in) :: coeff_in
  type(polynomial_coeff_type),intent(out) :: coeff_out
!local
!variable
  logical :: check
  character(len=500):: message
...
! *************************************************************************
 ...
 call polynomial_coeff_init(coeff_in%coefficient,coeff_in%nterm,&
&                           coeff_out,coeff_in%terms,coeff_in%name,check)
