...
subroutine vcoul_initt(Vcp,Gsph,Cryst,Qmesh,Kmesh,rcut,icutcoul,vcutgeo,ecut,ng,nqlwl,qlwl,ngfft,comm)
...
subroutine vcoul_plott(Vcp,Qmesh,Gsph,ng,vc,comm)
...
subroutine vcoul_printt(Vcp,unit,prtvol,mode_paral)
...
subroutine cutoff_spheret(nqpt,qpt,ngvec,gvec,gmet,rcut,vc_cut)
...
subroutine cutoff_cylindert(nq,qpt,ng,gvec,rcut,hcyl,pdir,boxcenter,rprimd,vccut,method,comm)
...
end subroutine cutoff_cylindert
!!***
...
subroutine cutoff_surfacet(nq,qpt,ng,gvec,gprimd,rcut,boxcenter,pdir,alpha,vc_cut,method)
...
end subroutine cutoff_surfacet
!!***
