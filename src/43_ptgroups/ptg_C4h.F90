...
! List of irreducible representations.
 ...
 Irr(5)%mat(:,:,3) =  RESHAPE( (/1*j/), (/1, 1/) )
 Irr(5)%mat(:,:,4) =  RESHAPE( (/-1*j/), (/1, 1/) )
 Irr(5)%mat(:,:,5) =  RESHAPE( (/1.0/), (/1, 1/) )
 Irr(5)%mat(:,:,6) =  RESHAPE( (/-1.0/), (/1, 1/) )
 Irr(5)%mat(:,:,7) =  RESHAPE( (/1*j/), (/1, 1/) )
 Irr(5)%mat(:,:,8) =  RESHAPE( (/-1*j/), (/1, 1/) )
 ...
 Irr(6)%mat(:,:,3) =  RESHAPE( (/1*j/), (/1, 1/) )
 Irr(6)%mat(:,:,4) =  RESHAPE( (/-1*j/), (/1, 1/) )
 Irr(6)%mat(:,:,5) =  RESHAPE( (/-1.0/), (/1, 1/) )
 Irr(6)%mat(:,:,6) =  RESHAPE( (/1.0/), (/1, 1/) )
 Irr(6)%mat(:,:,7) =  RESHAPE( (/-1*j/), (/1, 1/) )
 Irr(6)%mat(:,:,8) =  RESHAPE( (/1*j/), (/1, 1/) )
 ...
 Irr(7)%mat(:,:,3) =  RESHAPE( (/-1*j/), (/1, 1/) )
 Irr(7)%mat(:,:,4) =  RESHAPE( (/1*j/), (/1, 1/) )
 Irr(7)%mat(:,:,5) =  RESHAPE( (/1.0/), (/1, 1/) )
 Irr(7)%mat(:,:,6) =  RESHAPE( (/-1.0/), (/1, 1/) )
 Irr(7)%mat(:,:,7) =  RESHAPE( (/-1*j/), (/1, 1/) )
 Irr(7)%mat(:,:,8) =  RESHAPE( (/1*j/), (/1, 1/) )
 ...
 Irr(8)%mat(:,:,3) =  RESHAPE( (/-1*j/), (/1, 1/) )
 Irr(8)%mat(:,:,4) =  RESHAPE( (/1*j/), (/1, 1/) )
 Irr(8)%mat(:,:,5) =  RESHAPE( (/-1.0/), (/1, 1/) )
 Irr(8)%mat(:,:,6) =  RESHAPE( (/1.0/), (/1, 1/) )
 Irr(8)%mat(:,:,7) =  RESHAPE( (/1*j/), (/1, 1/) )
 Irr(8)%mat(:,:,8) =  RESHAPE( (/-1*j/), (/1, 1/) )
