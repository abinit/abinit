...
! List of irreducible representations.
 ...
 Irr(5)%mat(:,:,7) =  RESHAPE( (/0.0, 1.0, 1.0, 0.0/), (/2, 2/) )
 Irr(5)%mat(:,:,8) =  RESHAPE( (/0*j, -0.5+0.86603*j, -0.5-0.86603*j, 0*j/), (/2, 2/) )
 Irr(5)%mat(:,:,9) =  RESHAPE( (/0*j, -0.5-0.86603*j, -0.5+0.86603*j, 0*j/), (/2, 2/) )
 ...
 Irr(6)%mat(:,:,7) =  RESHAPE( (/0.0, 1.0, 1.0, 0.0/), (/2, 2/) )
 Irr(6)%mat(:,:,8) =  RESHAPE( (/0*j, -0.5+0.86603*j, -0.5-0.86603*j, 0*j/), (/2, 2/) )
 Irr(6)%mat(:,:,9) =  RESHAPE( (/0*j, -0.5-0.86603*j, -0.5+0.86603*j, 0*j/), (/2, 2/) )
