...
!  Compute xc potential (separate up and down if spin-polarized)
   if (dtset%icoulomb == 0 .and. dtset%usewvl == 0) then
     ...
     call xcdata_init(dtset%auxc_ixc,dtset%intxc,ixc_current,&
...
&          nhat,usepaw,nhatgr,nhatgrdim,nkxc,nk3xc,non_magnetic_xc,dtset%nspden,n3xccc,optxc,dtset%paral_kgb,&
