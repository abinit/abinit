...
!!
!! COPYRIGHT
!!  Copyright (C) 1998-2026 ABINIT group (XG, GMR, FJ, MT, EB, SPr)
...
&    dtset%ratsph,rprimd,dtset%spinat,dtset%typat,xred,dtset%ziontypat,dtset%znucl,dtset%qgbt,dtset%use_gbt,dtset%spinaxis)
