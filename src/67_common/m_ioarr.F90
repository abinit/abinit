...
! *************************************************************************
 ...
 if (my_rank == master) then
   ...
   if (ohdr%usepaw == 1) then
     ...
     call pawrhoij_alloc(pawrhoij_file, ohdr%pawrhoij(1)%cplex_rhoij, ohdr%pawrhoij(1)%nspden, &
&         ohdr%pawrhoij(1)%nspinor, ohdr%pawrhoij(1)%nsppol, ohdr%typat, lmnsize=ohdr%lmn_size, &
&         qphase=ohdr%pawrhoij(1)%qphase, zeromag=ohdr%pawrhoij(1)%zeromag)
