...
if test_type  =="2":       # Force
...
elif test_type=="5" or test_type=="51" or test_type=="54k":       # ddk
  ...
  INPUT_DIR=GENERIC_INPUT_DIR+"_STR"
elif test_type=="8" or test_type=="81":       # D2dk
  INPUT_DIR=GENERIC_INPUT_DIR+"_K"
...
ff=open("./input_template/"+INPUT_DIR+"/data")
...
for iatom in atom_list:   # Atom (optional)
  for idir1 in dir1_list:   # Perturbation 1
   for idir2 in dir2_list:  # Perturbation 2 (optional)
      ...
      elif test_type=="5" or test_type=="51":       # ddk
        idir       =0
        idirdfpt   =idir1
        input_index=idir1
        print ("k_dir=%d" %(idir1))
