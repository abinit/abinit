...
# doc/input_variables/html_automatically_generated/allvariables.html, displays all the names that cannot be
# identified and returns their count.
#
# Copyright (C) 2005-2016 ABINIT group (LSi)
# This file is distributed under the terms of the
# GNU General Public License, see ~abinit/COPYING
# or http://www.gnu.org/copyleft/gpl.txt .
# For the initials of contributors, see ~abinit/doc/developers/contributors.txt .
#
# NOTES : 1) this script is dependent of the file allvariables.html format;
...
# the file doc/input_variables/html_automatically_generated/allvariables.html . At the time of the current version
...
if ($Module eq 'abinit') {
  $InVarsFile = "doc/input_variables/html_automatically_generated/allvariables.html";
  }
else {
