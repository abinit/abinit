...
!!
!! COPYRIGHT
!! Copyright (C) 2008-2026 ABINIT group (MG,MT)
...
!Arguments ------------------------------------
 complex(dp),intent(in) :: xval
 complex(dp),intent(out) :: copy
! *********************************************************************
  copy=xval
...
!Arguments ------------------------------------
 complex(dp),pointer :: xval(:)
 complex(dp),pointer :: copy(:)
...
!Arguments ------------------------------------
 complex(dp),intent(in) :: xval(:)
 complex(dp),allocatable,intent(out) :: copy(:)
