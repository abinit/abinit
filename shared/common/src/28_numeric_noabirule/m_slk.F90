...
! *************************************************************************
 ...
 if (present(size_blocs)) then
   call out_mat%init(in_mat%sizeb_global(1), in_mat%sizeb_global(1), processor__, istwf_k, size_blocs=size_blocs)
 else
 ...
 !call out_mat%print(header="new matix generated by change_size_blocs")
