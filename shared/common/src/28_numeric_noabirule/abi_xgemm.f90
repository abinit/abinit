...
!!****f* m_abi_linalg/abi_d2zgemm_cptr
!! NAME
!! abi_d2zgemm
!!
!! FUNCTION
...
!! SOURCE
!!
subroutine abi_d2zgemm_core(TRANSA,TRANSB,M,N,K,ALPHA,A,LDA,B,LDB,BETA,C,LDC,&
                       x_cplx,gpu_option)
...
end subroutine abi_d2zgemm_core
!!***
...
!Local variables-------------------------------
 ...
 call abi_d2zgemm_3d(transa,transb,m,n,k,alpha,&
 &    a,lda,&
 &    b,ldb,&
 &    beta,&
 &    c,ldc,&
...
!! SOURCE
!!
subroutine abi_d2zgemm_3d(TRANSA,TRANSB,M,N,K,ALPHA,A,LDA,B,LDB,BETA,C,LDC,&
                       x_cplx,gpu_option)
