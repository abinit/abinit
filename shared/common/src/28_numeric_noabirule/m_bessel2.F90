...
!!
!! COPYRIGHT
!!  Copyright (C) 2024-2026 ABINIT group
...
!!****f* m_bessel2/bessel_iv
!! NAME
!! bessel_iv
!!
!! FUNCTION
!!
!! Compute modified Bessel function of the first kind for any real order
!!
!! INPUTS
!!  k= order
!!  xr= real part of the value at which to compute the Bessel function
!!  xi= real part of the value at which to compute the Bessel function
!!
!! OUTPUT
!!  ivr,ivi= real part and imaginary part of the value of the Bessel function
!!
!! SOURCE
...
!!****f* m_bessel2/bessel_kv
!! NAME
!! bessel_iv
!!
!! FUNCTION
!!
!! Compute modified Bessel function of the second kind for any real order
!!
!! INPUTS
!!  k= order
!!  xr= real part of the value at which to compute the Bessel function
...
!!
!! OUTPUT
!!  kvr,kvi= real part and imaginary part of the value of the Bessel function
!!
!! SOURCE
...
!C     COMPLEX CY,Z
     ...
     & FNU, FNUL, RL, R1M5, TOL, UFL, ZI, ZR, BB !D1MACH, AZABS
...
!C    *ZETA2,ZTH
     ...
     & ZETA2R, ZI, ZR, ZTHI, ZTHR, AC !, AZABS, D1MACH
...
!C     COMPLEX CSCL,CSCR,CY,RZ,ST,S1,S2,Y,Z
     ...
     & S2I, S2R, TOL, YI, YR, ZI, ZR, ASCLE, BRY, C1R, C1I, C1M!,AZABS &
     !& D1MACH
...
!C     COMPLEX AI,CONE,CSQ,CY,S1,S2,TRM1,TRM2,Z,ZTA,Z3
     ...
     & ZEROR, ZI, ZR, ZTAI, ZTAR, Z3I, Z3R, BB, ALAZ ! D1MACH, AZABS
