...
!!***
 ...
 public :: fex_ksdt   ! corrKSDT finite-temperature xc functional (correlation energy)
 public :: fec_ksdt   ! corrKSDT finite-temperature xc functional (exchange energy)
!!***
...
!!
!! SOURCE
subroutine fxc_ksdt(fxc,vxc,rs,t,iz)
!Arguments ------------------------------------
!scalars
...
!Local variables ------------------------------
!scalars
 real(dp),parameter :: onethird=1._dp/3._dp,threehalf=1.5_dp,lambda=(4._dp/9._dp/pi)**onethird,a0=1._dp/(pi*lambda)
...
!!
!! SOURCE
subroutine exc_ksdt(exc,rs,tsxc,t,iz)
!Arguments ------------------------------------
!scalars
 real(dp), intent(out) :: exc,tsxc
 real(dp), intent(in) :: rs,t
 integer, intent(in) :: iz
!Local variables ------------------------------
!scalars
 ...
 real(dp) :: aa,daa,bb,dbb,cc,dcc,dd,ddd,ee,dee
 real(dp) :: tanht,dtanht,tanhsqrt,dtanhsqrt,f1
 real(dp) :: num,dnum,den,dden,n,omega
!arrays
 real(dp) :: a(6),b(0:1,4),c(0:1,3),d(0:1,5),e(0:1,5)
...
! *************************************************************************
 ...
 t=degauss/2.0_DP/ef
 call fxc_ksdt(fxc,vxc,rs,t,0)
 call exc_ksdt(einxc,rs,tsxc,t,0)
