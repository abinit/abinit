...
/* FIXME
#define _ABI_MALLOC(arr, size) ABI_MALLOC(arr, size)
#define _ABI_FREE(arr) ABI_FREE(arr)
#define _ABI_ERROR(msg) ABI_ERROR(msg)
#define _ABI_WARNING(msg) ABI_WARNING(msg)
#define _ABI_BUG(msg) ABI_BUG(msg)
