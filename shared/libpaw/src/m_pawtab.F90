...
!-------------------------------------------------------------------------
!  beta,dncdq0,d2ncdq0,dnvdq0,dtaucdq0,edc,edcdc,eps,ex_cc,exccore,lamb_shielding,lambda,rpaw,rshp,rcore,rcoretau,shape_sigma
   nn_dpr=nn_dpr+17
...
!Reals (read from psp file)
   ...
   list_dpr(ii)=pawtab%edc  ;ii=ii+1
   list_dpr(ii)=pawtab%edcdc  ;ii=ii+1
...
!Reals (read from psp file)
   ...
   pawtab%edc=list_dpr(ii)  ;ii=ii+1
   pawtab%edcdc=list_dpr(ii)  ;ii=ii+1 
