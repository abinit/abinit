...
Warning:
The value [[brav]]=-1 is also possible. It is used for backwards compatibility: it corresponds to [[brav]]=1, with the weights for the
interpolation of the phonon band structure determined by another (now obsolete) algorithm than the default [[brav]]=1 algorithm
