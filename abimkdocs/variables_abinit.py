...
Variable(
    ...
    varset="dfpt",
    vartype="integer",
    topics=['nonlinear_basic', 'ConstrainedDFPT'],
    dimensions=[2],
    defaultval=[1, '[[natom]]' ],
...
Variable(
    ...
    varset="dfpt",
    vartype="integer",
    topics=['longwave_expert', 'ConstrainedDFPT'],
    dimensions=[2],
    defaultval=[1, '[[natom]]' ],
...
Variable(
    ...
    varset="dfpt",
    vartype="real",
    topics=['DFPT_expert', 'ConstrainedDFPT'],
    dimensions="scalar",
    defaultval=0.0,
...
Variable(
    ...
    varset="dfpt",
    vartype="integer",
    topics=['DFPT_basic', 'ConstrainedDFPT'],
    dimensions="scalar",
    defaultval=0,
...
Variable(
    ...
    varset="dfpt",
    vartype="integer",
    topics=['DFPT_expert', 'DFPT_internal', 'ConstrainedDFPT'],
    dimensions="scalar",
    defaultval=1,
