...
Why not create Work_ffield in \$ABI_TUTORESPFN/Input?*
...
(DFPT) can be done by using the file *\$ABI_TUTORESPFN/Input/tffield_2.in*. 
...
The DDB generated by *\$ABI_TUTORESPFN/Input/tffield_2.in* can be used as input to
...
You can now copy the file *\$ABI_TUTORESPFN/Input/tffield_6.in* in *Work_ffield*, 
