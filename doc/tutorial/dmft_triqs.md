...
(see [basic1](../tutorial/base1.md), [basic2](../tutorial/base2.md), [basic3](../tutorial/base3.md),
and [basic4](../tutorial/base4.md)). It also helps if you are familiar with PAW
(see [PAW1](../tutorial/paw1.md) and [PAW2](../tutorial/paw2.md)) and [DFT+U](../tutorial/dftu.md).
There is also a tutorial on the ABINIT's internal DMFT solvers (see [DMFT](../tutorial/dmft.md)), but
...
There are several ways to compute these parameters directly within ABINIT — for example, using [cRPA](../tutorial/ucalc_crpa.md) or [linear response](../tutorial/lruj.md) - but those
...
If instead you want to use ABINIT’s internal DMFT implementation with its built-in solvers, check out the dedicated [DMFT tutorial](../tutorial/dmft.md).
