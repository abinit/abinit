...
A new, more efficient workflow is presented in Tutorial [Introduction to the new EPH workflow](../tutorial/eph_intro.md).
...
It is presumed that the user has already followed the Tutorials [RF1](../tutorial/rf1.md) and [RF2](../tutorial/rf2.md),
...
It, too, should be converged to get physical results (see [Tutorial 3](../tutorial/base3.md)).
...
vectors.). The whole calculation follows the same lines as [Tutorial RF1](../tutorial/rf1.md).
...
the first reduced direction for q=(1/2,0,0). The main differences with [Tutorial RF1](../tutorial/rf1.md)
...
structure in [the tutorial 3](../tutorial/base3.md). The path is specified by the
...
a DDK calculation (see [the first DFPT tutorial (DFPT1)](../tutorial/rf1.md).
