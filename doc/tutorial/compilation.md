...
different versions without affecting the software installed by our distribution.
...
in the $HOME/local/include directory:
...
This means that these libraries are now mandatory.
...
To pinpoint the source of the problem you will need to inspect *config.log* for possible clues,
...
If we want to understand why *configure* failed, we have to open *config.log* in the editor
...
with the build system of version 9.
