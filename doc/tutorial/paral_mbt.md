...
In the [first GW tutorial](../tutorial/gw1.md), we have learned how to
...
We have already encountered these variables in the [first GW tutorial](../tutorial/gw1.md)
...
[first GW tutorial](../tutorial/gw1.md). The only variables that
...
standard converge tests following the procedure described in the [first GW tutorial](../tutorial/gw1.md).
...
the documentation and to the [first GW tutorial](../tutorial/gw1.md)
