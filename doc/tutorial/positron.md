...
The user should be familiar with the four basic tutorials of `ABINIT` and the [first PAW tutorial](../tutorial/paw1.md).
...
(see [the tutorial on generating PAW datasets (PAW2)](../tutorial/paw2.md) ) by the use of the
...
you can follow the [tutorial on generating PAW datasets (PAW2)](../tutorial/paw2.md).
