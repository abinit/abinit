...
Let us immediately start the job in background with:
...
when many empty states are required, especially if one can take advantage of ScaLAPACK/ELPA
...
Here, we ask for 400 bands. Let us recall that in the [previous GW tutorial](../tutorial/gw1.md)
...
are much easier to converge than absolute QP values.
