...
input_file1_r = open(input_file1_name)  # open it as read file
...
input_file2_r = open(input_file2_name)  # open it as read file
...
if align_values:
    ...
    for iline in range(len(elk_file_data)-1):
        kpt = kpt + 1
    ...
    input_file2_r.close()
    input_file2_r = open(input_file2_name)
