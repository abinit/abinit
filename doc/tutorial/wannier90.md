...
Before starting it is assumed that you have already completed the tutorials [PAW1](../tutorial/paw1.md) and [PAW2](../tutorial/paw2.md).
...
Now run Wannier90. Find the location of the executable wannier90.x and issue

    wannier90.x tw90_4o_DS3_w90

If the wannier90.x executable has been generated by the fallbacks procedure, 
you might have to issue a command like
...
To plot the bands, it is possible to use |gnuplot|.
First edit the gnuplot file generated by wannier90, *tw90_4o_DS3_w90_band.gnu*,
and add at the end of the file

    pause -1 

Then open |gnuplot| in the terminal and type:
