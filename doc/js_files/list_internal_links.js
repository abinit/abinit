...
document.write(' <B> | </B> ');
document.write(' <A href="'+docpath+'users/generated_files/help_features.html"><B>ABINIT features ("How to")</B></A> ');
document.write(' <B> | </B> ');
document.write(' <A href="'+docpath+'tutorial/generated_files/lesson_welcome.html"><B>Tutorial (lessons)</B></A> ');
document.write(' <HR ALIGN=left> ');
