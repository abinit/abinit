...
A detailed description of *our markdown dialect* is given in [our markdown page](../developers/markdown.md).
Also [MathJax](https://www.mathjax.org/) for equations in LaTeX is activated,
and the (few) specificities of its usage in the Abinit docs are explained [in this section](../developers/markdown.md#mathjax).
...
* The fact the [wikilink syntax](../developers/markdown.md#wikilinks) facilitates the inclusion of hyperlinks does not
...
In order to refer to a bibliography entry, use the [Wikilink syntax](../developers/markdown.md#wikilinks) with the "cite" namespace.
...
Release notes are written in Markdown so it is possible to use the [wikilink syntax](../developers/markdown.md#wikilinks)
