...
cut3d 
:   can be used to post-process the three-dimensional density (or
...
fold2Bloch
:   is used for unfolding first-principle electronic band structures

aim
:   is also a post-processor of the three-dimensional density files
