...
##file_specs = 'specials.html'
##f_sp = open(file_specs,'w')
##header_specs = header_specs.replace("__JS_PATH__",js_path)
##f_sp.write(header_specs)
##cur_let = 'A'
