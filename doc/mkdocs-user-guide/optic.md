...
Ref. 1 to determine the nonlinear optical response of the material under investigation.
...
abinit program, four different files, corresponding to the physical system that you want to study:
  ...
  * Three files containing the matrix elements of the position operator 
    (or the derivative with respect to wavevector), one for each direction of space
...
(1997), or Nunes and Gonze, Phys. Rev. B 63, 155107 (2001), and references therein. 
...
Two most common mistakes are:
  ...
  * (i) You are calculating the second order response for material with inversion symmetry 
    in this case all the components will be correctly zero or very small like 10-15.
