...
calculation). The parallelisation of this step is examined in a separate lesson.  
...
several) DDB file(s). As explained in related tutorials (see e.g. 
[Response-Function 1](lesson_rf1.html)), several perturbations are usually treated in
