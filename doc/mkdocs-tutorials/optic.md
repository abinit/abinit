...
for the other lessons. Why not create "Work_optic" in ~abinit/tests/tutorespfn/Input ?_

In order to use the Optic utility, you should first have some theoretical background. 
Could you read the [introduction of the optic help file](../../users/generated_files/help_optic.html#1), 
then the [section 2](../../users/generated_files/help_optic.html#2) of this help file?
...
28x28x28). For information, we give some timings of the corresponding ABINIT run for a 2.8 GHz PC:
