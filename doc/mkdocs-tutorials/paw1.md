...
_~abinit/tests/tutorial/Refs and __~abinit/tests/tutorial/Refs/tpaw1_addons_
_directories (for the present tutorial they are named tpaw1_*.out)._
...
Let's open the output file and have a look inside (be careful, it is the last
...
able to compare numbers for (valence) _energies_ between different PAW
...
**3.a** **Computing the convergence in ecut for  diamond in the norm-
conserving case**
...
The etotal convergence (at the 1 mHartree level) is achieved for 12<=ecut<=14
Hartree ;  
...
**8.a** **Mixing scheme for the Self-Consistent cycle; decomposition of the
total energy.**
