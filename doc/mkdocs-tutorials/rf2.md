...
for the other lessons. Why not create "Work_rf2" in ~abinit/tests/tutorespfn/Input ?_
...
MRGDDB. You can copy it in the Work_rf2 directory, and run the merge as follows:
