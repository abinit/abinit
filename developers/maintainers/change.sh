...
do
 ...
 rm -f tmp.file 
 sed -e 's!and transformation to cartesian coordinates may be wrong.!and transformation to cartesian coordinates may be wrong. Check input variable rfdir.!' $file > tmp.file
 echo "changes done "
