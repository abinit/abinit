...
class AboFileAnalysis:
    ...
    Attributes:
        file_type (str): Type of file ("abo").
        file_name (str): Name of the file being analyzed.
        option (str): Type of information extracted.
        dtsets (list): List of extracted datasets.
    """
    ...
    def __init__(self, file_name, option):
        ...
        Args:
            ...
            option (str): Type of information to extract (e.g., "iterations").
        """
        self.file_type = "abo"
