...
print("for 0 GPa:")
print(f"z2 topological invariant at kz = 0.0: {z2pack.invariant.z2(result_0)}")
print(f"z2 topological invariant at kz = 0.5: {z2pack.invariant.z2(result_1)}")
print("for 5 GPa:")
print(f"z2 topological invariant at kz = 0.0: {z2pack.invariant.z2(result_2)}")
print(f"z2 topological invariant at kz = 0.5: {z2pack.invariant.z2(result_3)}")
