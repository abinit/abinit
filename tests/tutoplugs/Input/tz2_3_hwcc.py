...
ax[0,0].set_title(
    rf"$0 GPa, k_z=0.0, \Delta={z2pack.invariant.z2(result_0)}$",
    fontsize=fs
)
ax[0,1].set_title(
    rf"$ 0 GPa, k_z=0.5, \Delta={z2pack.invariant.z2(result_1)}$",
    fontsize=fs
)
ax[1,0].set_ylabel(r"$\bar{y}$", rotation="horizontal", fontsize=fs)
ax[1,0].set_title(
    rf"$5 GPa, k_z=0.0, \Delta={z2pack.invariant.z2(result_2)}$",
    fontsize=fs
)
ax[1,1].set_title(
    rf"$ 5 GPa, k_z=0.5, \Delta={z2pack.invariant.z2(result_3)}$",
    fontsize=fs
)
